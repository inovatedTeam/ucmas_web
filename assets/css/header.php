...
<!--                            <a href="javascript:change_lang('--><?//=base_url()?><!--','se')">SE</a>-->
                    ...
                    <div class="dropdown">
                        ...
                        <div id="dropdown_country2" class="dropdown-content">
                            ...
                            <a href="#"><img class="img-flag" src="<?=base_url()?>assets/images/flags/no.png">NO</a>
                            <a href="#"><img class="img-flag" src="<?=base_url()?>assets/images/flags/se.png">SE</a>
                        </div>
                    </div>
                </div>
                    ...
                    <ul id="menu-menu" class="menus-mobile">
                        ...
                        <li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-has-children">
                            ...
                            <ul  class="sub-menu">
                                ...
                                <li class="menu-item menu-item-type-custom menu-item-object-custom">
                                    <a href="<?=base_url()?>about/intro_history"><?=lang('mn_aboutUs_intro')?></a>
                                </li>
                                <li class="menu-item menu-item-type-custom menu-item-object-custom">
                                    <a href="<?=base_url()?>about/ucmas_culture"><?=lang('mn_aboutUs_calture')?></a>
                                </li>
                                <li class="menu-item menu-item-type-custom menu-item-object-custom">
                                    <a href="<?=base_url()?>about/benefit_math"><?=lang('mn_aboutUs_benefit')?></a>
                                </li>
                                <li class="menu-item menu-item-type-custom menu-item-object-custom">
                        ...
                        <li class="menu-item menu-item-type-post_type menu-item-object-page">
                            <a href="<?=base_url()?>search"><?=lang('mn_classes')?></a>
                        </li>
                        <li class="menu-item menu-item-type-post_type menu-item-object-page">
