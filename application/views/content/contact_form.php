                        ...
                        <article class="post-item">
                            <div class="post-content">
                                ...
                                <div class="body-block">
                                    <p>
                                        I would like to have different categories and based on the categories, different fields would appear.
                                    </p>
                                    <ul>
                                        <li>
                                            Interested in registering my child
                                        </li>
                                        <li>
                                            Interested in working as a course instructor (teacher)
                                        </li>
                                        <li>
                                    ...
                                    <p>
                                        So the fields below are just examples, but please suggest how we can have more information.
                                    </p>
                                </div>
                                <div class="row">
                                    <div class="col-md-12">
