                ...
                <div class="card">
                    <h3 class="card-header primary-color white-text font-bold" style="line-height: 50px;">
                        ...
                        <span class="table-add float-right">
                            <a href="<?=base_url()?>admin/exercise_type/edit/0" class="btn-floating btn-sm"><i class="fa fa-plus"></i></a>
                        </span>
                    </h3>
                    <div class="card-body">
                        <table id="example" class="table table-striped table-bordered table-responsive table-hover" cellspacing="0">
                            ...
                            <?php
                                foreach ($exercise_types as $exercise_type){
                                    ...
                                    echo '<td>
                                            <a href="'.base_url().'admin/exercise_type/edit/'.$id.'" rel="tooltip" title="Edit"><i class="fa fa-edit"></i></a>
...
<script>
    ...
    function delete_action(id) {
        $("#btn_delete").attr("href", BASE_URL + 'admin/exercise_type/delete/' + id);
