                ...
                <div class="card">
                    <h3 class="card-header primary-color white-text font-bold" style="line-height: 50px;">
                        ...
                        <span class="table-add float-right">
                            <a href="<?=base_url()?>admin/teacher/edit/0" class="btn-floating btn-sm"><i class="fa fa-plus"></i></a>
                        </span>
                    </h3>
                    <div class="card-body">
                        <table id="example" class="table table-striped table-bordered table-responsive table-hover" cellspacing="0">
                            ...
                            <?php
                                foreach ($teachers as $teacher){
                                    ...
                                    echo '<td>'.$phone.'</td>';
                                    echo '<td>
                                            <a href="'.base_url().'admin/teacher/edit/'.$id.'" rel="tooltip" title="Edit"><i class="fa fa-edit"></i></a>
