                ...
                <div class="col-md-6">
                    <div class="card">
                        <h3 class="card-header primary-color white-text font-bold" style="line-height: 50px;">
                            <?php extract($user); echo $id == 0 ? "New" : "Edit" ?> User
                        </h3>
                        <div class="card-body px-lg-6">
                            <form method="post" action="<?=base_url()?>admin/user/save/<?=$id?>">
                                <div class="" >
                                    <div class="md-form">
                                        <?php
                                    ...
                                    if($id == 0){
                                        ...
                                        echo '<input id="password" name="password" type="password" minlength="3" value="" required>';
                                        echo '<label for="password">Password</label></div>';
                                    }
                                    ?>

                                    <div class="md-form text-right">
                                        <a href="<?=base_url()?>admin/user/view" class="btn btn-danger pull-left">Cancel</a>
                ...
                <div class="col-md-6">
                    ...
                    if($id > 0){ ?>
                        <div class="card">
                            ...
                            <div class="card-body px-lg-6">
                                <form id="change_password_form" method="post" action="<?=base_url()?>admin/user/change_password/<?=$id?>">
                                    <div class="" >
                                        <div class="md-form">
                                            <?php
