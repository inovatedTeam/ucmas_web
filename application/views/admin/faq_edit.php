            ...
            <div class="row">
                <div class="card" style="width: 100%;">
                    <h3 class="card-header primary-color white-text font-bold" style="line-height: 50px;">
                        <?php extract($faq); echo $id == 0 ? "New" : "Edit" ?> Faq
                    </h3>
                    <div class="card-body">
                        <div class="row">
                            <form method="post" action="<?=base_url()?>admin/faq/save/<?=$id?>">
                                <div class="col-6" style="float: left;">
                                    ...
                                    <div class="md-form">
                                        <input id="faq_title" name="faq_title" type="text" value="<?=$faq[$sel_lang.'_faq_title']?>" required>
...
<script>
    ...
    $(document).ready(function() {
        ...
        var old_description = "<?php echo $faq[$sel_lang.'_description']?>";
        $("#description").Editor();
