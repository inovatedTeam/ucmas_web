                        ...
                        <table id="example" class="table table-striped table-bordered table-responsive table-hover" cellspacing="0">
                            ...
                            <?php
                                foreach ($classrooms as $classroom){
                                    ...
                                    echo '<td>
                                            <a href="'.base_url().'admin/classroom/edit/'.$level_id.'/'.$course_id.'/'.$c_id.'" rel="tooltip" title="Edit"><i class="fa fa-edit"></i></a>
                                            <a href="javascript:delete_action('.$c_id.')" rel="tooltip" title="Delete"><i class="fa fa-times mx-1"></i></a>
                                          </td>';
                                    echo '</tr>';
                                }
