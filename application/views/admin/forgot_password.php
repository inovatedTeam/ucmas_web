                    ...
                    <div class="col-xl-5 col-lg-6 col-md-10 col-sm-12 mx-auto mt-lg-5">
                        ...
                        <div class="card wow fadeIn" data-wow-delay="0.3s" style="animation-name: none; visibility: visible;">
                            <div class="card-body">
                                ...
                                <form action="<?=base_url()?>admin/forgot_password_request" method="post">
                                <!--Body-->
                                <div class="md-form">
                                    <?php
                                    if($err == "Admin sent new password to your email"){
                                        echo '<p style="color: blue;text-align: center;    background-color: #bbbbbb;">'.$err.'</p>';
                                    }else{
                                ...
                                <div class="text-center">
                                    <a href="<?=base_url()?>admin/login" class="pull-left" style="margin-top: 20px;color: white;">Login Page</a>
                                    <button class="btn purple-gradient btn-lg waves-effect waves-light pull-right">Send</button>
                                </div>
                                </form>
                            </div>
                        </div>
